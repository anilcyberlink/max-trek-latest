      ...
      <div class="panel">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <div class="bs-component">
                <input type="text" id="category" name="lname" class="form-control" placeholder="" required />
              </div>
            </div>
          </div>
          ...
          <!-- <div class="form-group">
            ...
            <div class="col-lg-8">
              <div class="bs-component">
                <div class="bs-component">
                  <textarea class="textarea form-control" id="textArea3" name="brief" rows="9"
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <div class="bs-component">
                <div class="bs-component">
                  <textarea class=" form-control" id="" name="content" rows="9"
                    autocomplete="off"></textarea>
                </div>
              </div>
            </div>
