...
<a href="{{ url('admin/tripgrade') }}" class="btn btn-default btn-sm backlink"><i class="fa fa-list" aria-hidden="true"></i> Show List </a>
@endsection

@section('content')
<form class="form-horizontal" role="form" action="{{ url('admin/tripgrade/'.$data->id) }}" method="post" enctype="multipart/form-data">
  {{ csrf_field() }}    
  ...
  <div class="col-md-9">
    ...
    <div class="panel">
      ...
      <div class="panel-body">                    
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <div class="bs-component">
              <input type="text" id="trip_grade" name="trip_grade" class="form-control" value="{{$data->trip_grade}}" placeholder="Title" />
        ...
        <div class="form-group">
          <label class="col-lg-2 control-label" for="textArea3">Message</label>
          <div class="col-lg-9">
            <div class="bs-component">
             <textarea class="form-control my-editor" id="" name="grade_message" rows="3">{{$data->grade_message}}</textarea>
            </div>
          </div>
        </div>
...
<script type="text/javascript">
  ...
  $('.imagedelete').on('click',function(e){
    ...
    $.ajax({
      type:'delete',
      url:"{{url('delete_tripgrade_thumb') . '/'}}" + id,
      data:{_token:csrf},    
