...
@section('content')
<form class="form-horizontal" role="form" action="{{ url('admin/tripgrade') }}" method="post" enctype="multipart/form-data">
  {{ csrf_field() }}    
  ...
  <div class="col-md-9">
    ...
    <div class="panel">
      <div class="panel-heading">
        <span class="panel-title"> New Trip Grade </span>
      </div>
      <div class="panel-body">                    
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <div class="bs-component">
              <input type="text" id="trip_grade" name="trip_grade" class="form-control" placeholder="" />
       ...
       <div class="form-group">
         <label for="inputStandard" class="col-lg-2 control-label">Message</label>
          <div class="col-lg-9">
            <div class="bs-component">
              <textarea class="form-control my-editor" id="" name="grade_message" rows="3"></textarea>
            </div>
          </div>
        </div>
