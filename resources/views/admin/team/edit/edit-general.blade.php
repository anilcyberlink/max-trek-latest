...
<div class="col-md-3">
  ...
  <div class="sid_bvijay mb10">
    <label class="field text">
      ...
      <input type="text" id="" name="facebook_url" class="form-control" placeholder="Facebook Link" value="{{$data->facebook_url}}" />   
     </label>
   </div>
   <div class="sid_bvijay mb10">
    <label class="field text">
   ...
   <div class="sid_bvijay mb10">
    ...
    <label class="field text">
      <input type="text" id="" name="youtube_url" class="form-control" placeholder="YouTube Link" value="{{$data->youtube_url}}" />   
     </label>
   </div>
   <div class="sid_bvijay mb10">
    <label for="inputStandard" class="col-lg-2 control-label">Wikipedia</label>
    <label class="field text">
      <input type="text" id="" name="wikipedia_url" class="form-control" placeholder="Wikipedia Link" value="{{$data->wikipedia_url}}" />   
     </label>
   </div>
